...
public class OI {
    ...
    public JoystickButton rightBumper, leftBumper;
    ...
    public OI() {
        ...
        leftTrigger.whileHeld(new IntakeCube());
        ...
        rightBumper = new JoystickButton (operator, 5);
        rightBumper.whileHeld(new ElevatorUp());
        
        leftBumper = new JoystickButton (operator, 6);
