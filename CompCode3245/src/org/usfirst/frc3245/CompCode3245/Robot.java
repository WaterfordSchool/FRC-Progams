...
public class Robot extends TimedRobot {
   ...
   public static CartArms cartArms;
    wrist = new Wrist();
    public static Talon leftFrontMotor = RobotMap.driveTrainLeftFrontMotor;
   public static Talon leftRearMotor = RobotMap.driveTrainLeftRearMotor;
    public static Talon rightFrontMotor = RobotMap.driveTrainRightFrontMotor;
    public static Talon rightRearMotor = RobotMap.driveTrainRightRearMotor;
    public static WPI_TalonSRX intakeLeftMotor = RobotMap.driveTrainIntakeLeftMotor;
    ...
    public void autonomousInit() {
        ...
        if(gameData.length() > 0) {
        	if(gameData.charAt(0) == 'L' && startingPosition == "Left") {
        		...
        		autonomousCommand = new DriveStraightPID(2000.0);
        	}
        	else {
        		autonomousCommand = new DriveStraightPID(2000.0); 
        	}
